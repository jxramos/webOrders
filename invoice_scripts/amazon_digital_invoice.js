...
function retitlePage(transaction) {
    ...
    pageTitle.singleNodeValue.innerText = transaction["OrderDateFormatted"] + " " + pageTitle.singleNodeValue.innerText.replace("Digital Order Summary", "Order ") + transaction["Order#"]
}
